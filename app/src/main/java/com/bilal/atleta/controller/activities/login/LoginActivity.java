package com.bilal.atleta.controller.activities.login;
...
import com.bilal.atleta.controller.activities.main.MainActivity;
import com.bilal.atleta.R;
import com.bilal.atleta.controller.managers.LoginCallback;
import com.bilal.atleta.controller.managers.UserLoginManager;
...
public class LoginActivity extends AppCompatActivity implements LoginCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), RegisterActivity.class); // intent en fragments
                startActivity(i);
            }
        });
